...
std::vector<Point *> pEllipse3; // 11
std::vector<Point *> pEllipse4; // 22
...
points.push_back(geo1->addPoint({0.0, 0.0, 0.0}, lcar2));
points.push_back(geo1->addPoint({-L / 2, -dL, 0.0}, elSize));
...
pEllipse3.push_back(geo1->addPoint({xx1, -yy1, 0.0}, lcar2));
...
for (double thetai = -M_PI; thetai <= M_PI; thetai += (2 * M_PI) / np)
{
    ...
    if (yi < 0.0)
        pEllipse3.push_back(geo1->addPoint({coord2[0], coord2[1], 0.0}, lcar2));
}

pEllipse3.push_back(geo1->addPoint({xx2, yy2, 0.0}, lcar2));
pEllipse4.push_back(pEllipse3.back());
...
for (double thetai = -M_PI; thetai <= M_PI; thetai += (2 * M_PI) / np)
{
    ...
    if (yi > 0.0)
        pEllipse4.push_back(geo1->addPoint({coord2[0], coord2[1], 0.0}, lcar2));
}

pEllipse4.push_back(geo1->addPoint({xx1, yy1, 0.0}, lcar2));
...
lines.push_back(geo1->addLine({pEllipse2.back(), pEllipse4.back()})); // 5
lines.push_back(geo1->addLine({pEllipse4.back(), points[5]}));        // 6

lines.push_back(geo1->addLine({points[5], pEllipse3[0]}));    // 7
lines.push_back(geo1->addLine({pEllipse3[0], pEllipse1[0]})); // 8
lines.push_back(geo1->addLine({pEllipse1[0], points[6]}));    // 9
...
lines.push_back(geo1->addSpline(pEllipse3)); // 13 - e3
lines.push_back(geo1->addSpline(pEllipse4)); // 14 - e4

lineLoops.push_back(geo1->addLineLoop({lines[0], lines[1], lines[2], lines[3], lines[4], lines[12], lines[11], lines[9], lines[10]}));

lineLoops.push_back(geo1->addLineLoop({lines[5], lines[14], lines[13], lines[8], lines[11], lines[12]}));
lineLoops.push_back(geo1->addLineLoop({lines[6], lines[7], lines[13], lines[14]}));
