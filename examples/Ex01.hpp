...
points.push_back(geo1->addPoint({0.0, 0.0, 0.0}, 100.));
points.push_back(geo1->addPoint({geo1->getEdgeLength(), 0.0, 0.0}, 100.));
points.push_back(geo1->addPoint({geo1->getEdgeLength(), geo1->getEdgeLength(), 0.0}, 100.));
points.push_back(geo1->addPoint({0.0, geo1->getEdgeLength(), 0.0}, 100.));
